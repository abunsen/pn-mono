...
class PaymentMethodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_method" do
    assert_difference("PaymentMethod.count") do
      post payment_methods_url, params: { payment_method: { account_id: @payment_method.account_id, ex_id: @payment_method.ex_id, kind: @payment_method.kind, last_4: @payment_method.last_4 } }
    end
  ...
  test "should update payment_method" do
    patch payment_method_url(@payment_method), params: { payment_method: { account_id: @payment_method.account_id, ex_id: @payment_method.ex_id, kind: @payment_method.kind, last_4: @payment_method.last_4 } }
