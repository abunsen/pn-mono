...
class PaymentMethodsTest < ApplicationSystemTestCase
  ...
  test "should create payment method" do
    ...
    fill_in "Account", with: @payment_method.account_id
    fill_in "Ex", with: @payment_method.ex_id
    fill_in "Kind", with: @payment_method.kind
    fill_in "Last 4", with: @payment_method.last_4
